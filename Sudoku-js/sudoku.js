...
window.onload = function () {
    ...
    createSudokuSolver();
    createHowtoPlay();
}; //Creating a window that calls a function to generate a sudoku matrix, create a clear, new game, how to play and sudoku solver button and creates the actual sudoku grid
